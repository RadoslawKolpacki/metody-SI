...
class Ant:
    def __init__(self, bounds):
        ...
        self.score = drop_wave(self.position)
...
# Example usage:
bounds = [-5.12, 5.12]  # Bounds for each variable
num_ants = 20
num_iterations = 100
alpha = 1.0
beta = 2.0
...
acs = AntColonySystem(drop_wave, bounds, num_ants, num_iterations, alpha, beta, rho, q0)
best_solution = acs.optimize()
best_score = drop_wave(best_solution)
